...
const SONGS = [
  ...
  { id: 4, title: "Stay", artist: "The Kid LAROI & Justin Bieber", album: "F*CK LOVE 3", genre: "Pop", duration: "2:21", year: 2021, audioUrl: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3", coverUrl: "https://picsum.photos/seed/song4/300/300", plays: 65000000 },
  ...
  { id: 18, title: "Industry Baby", artist: "Lil Nas X & Jack Harlow", album: "MONTERO", genre: "Hip-Hop", duration: "3:32", year: 2021, audioUrl: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3", coverUrl: "https://picsum.photos/seed/song18/300/300", plays: 35000000 },
  ...
  { id: 24, title: "Tera Ban Jaunga", artist: "Akhil & Tulsi Kumar", album: "Kabir Singh", genre: "Bollywood", duration: "3:42", year: 2019, audioUrl: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3", coverUrl: "https://picsum.photos/seed/song24/300/300", plays: 65000000 },
  ...
  { id: 44, title: "Senorita", artist: "Shawn Mendes & Camila Cabello", album: "Senorita", genre: "Pop", duration: "3:10", year: 2019, audioUrl: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3", coverUrl: "https://picsum.photos/seed/song44/300/300", plays: 50000000 },
  ...
  { id: 47, title: "Naatu Naatu", artist: "Rahul Sipligunj & Kaala Bhairava", album: "RRR", genre: "Telugu", duration: "4:35", year: 2022, audioUrl: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-15.mp3", coverUrl: "https://picsum.photos/seed/song47/300/300", plays: 55000000 },
  ...
  { id: 49, title: "Ghungroo", artist: "Arijit Singh & Shilpa Rao", album: "War", genre: "Bollywood", duration: "4:08", year: 2019, audioUrl: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3", coverUrl: "https://picsum.photos/seed/song49/300/300", plays: 44000000 },
...
export function MusicProvider({ children }) {
  ...
  const [favorites, setFavorites] = useState(() => {
    return JSON.parse(localStorage.getItem('musicapp_favorites') || '[]');
  });
  const [playlists, setPlaylists] = useState(() => {
    return JSON.parse(localStorage.getItem('musicapp_playlists') || '[]');
  });
  ...
  useEffect(() => {
    localStorage.setItem('musicapp_favorites', JSON.stringify(favorites));
  }, [favorites]);
  ...
  const playNext = () => {
    ...
    playSongDirect(SONGS[(idx + 1) % SONGS.length]);
  };

  const playPrev = () => {
    if (!currentSong) return;
    const idx = SONGS.findIndex(s => s.id === currentSong.id);
    playSongDirect(SONGS[(idx - 1 + SONGS.length) % SONGS.length]);
  };
